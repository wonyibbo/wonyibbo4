...
function getMealInfo() {
    ...
    const url = `https://open.neis.go.kr/hub/mealServiceDietInfo?ATPT_OFCDC_SC_CODE=${SCHOOL_INFO.ATPT_OFCDC_SC_CODE}&SD_SCHUL_CODE=${SCHOOL_INFO.SD_SCHUL_CODE}&MLSV_YMD=${formattedDate}&Type=json`;
    ...
    // 급식 정보를 표시할 콜백 함수
    window.displayMealInfo = function(data) {
    ...
    script.src = `${url}&callback=displayMealInfo`;
